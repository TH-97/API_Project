...
document.getElementById("data-search-btn").addEventListener("click", function(){
    ...
    const url = location.href="https://www.data.go.kr/tcs/dss/selectDataSetList.do?keyword=" + keyWord +" &brm=&svcType=&instt=&recmSe=N&conditionType=init&extsn=&kwrdArray="
